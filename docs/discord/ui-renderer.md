...
- 2026-07-14: Historical trial entrypoint migration; current target selection and pagination are documented in the 2026-08-15 entry above.
- 2026-07-14: Historical trial UI migration; the shared trial status line and post-submission feedback remain part of the current renderer contract.
